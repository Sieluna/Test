...
use super::{BufOps, BufferError, DescriptorSet, Framework, GpuBuffer, GpuBufferUsage};
...
where
    ...
    D: ndarray::Dimension,
{
    pub fn from_array(fw: &'fw Framework, array: ndarray::ArrayView<T, D>) -> ArrayResult<Self> {
